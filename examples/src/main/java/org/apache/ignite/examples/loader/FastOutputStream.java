 ...
 *
 * <p>This class extends {@link OutputStream} and its <code>write()</code> methods allow it to be used as a standard
 * output stream.  In addition, it provides <code>writeFast()</code> methods that are not declared to throw
 * <code>IOException</code>.  <code>IOException</code> is never thrown by this class.</p>
 *
 * @author Mark Hayes
 */
public class FastOutputStream extends OutputStream {
    ...
    /**
     * The default amount that the buffer is increased when it is full.  This constant is zero, which means to double
     ...
     *
     * @param buffer the initial buffer; will be owned by this object.
     * @param bumpSize the amount to increment the buffer.  If zero (the default), the current buffer size will be
     * doubled when the buffer is full.
     */

...
export class PcListEditableColsController {
...
export default function pcListEditableCols() {
    return {
        controller: PcListEditableColsController,
        controllerAs: '$colsCtrl',
        require: {
            ngModel: 'ngModel'
        },
        bindToController: {
            colDefs: '<pcListEditableCols',
            rowClass: '@?pcListEditableColsRowClass'
        }
    };
}

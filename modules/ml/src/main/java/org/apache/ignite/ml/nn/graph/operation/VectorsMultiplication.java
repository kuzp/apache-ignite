 ...
 */
public class VectorsMultiplication<T extends Vector> implements Operator<T> {
    /**
     * Build operator.
     */
    public static VectorsMultiplication getInstance(){
        return new VectorsMultiplication();
    }
